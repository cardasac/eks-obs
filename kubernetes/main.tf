resource "helm_release" "grafana-k8s-monitoring" {
  ...
  set {
    name  = "metrics.alloy.metricsTuning.useIntegrationAllowList"
    value = var.metrics_alloy_metricstuning_useintegrationallowlist
  }
  ...
  set {
    name  = "extraConfig"
    value = file("${path.module}/config.alloy")
  }
}
